...
export const setupLights = (scene, debug = false) => {
  ...
  const hemiLight1Lighthelper = new THREE.HemisphereLightHelper(
    hemiLight1,
    2,
    0xff0000
  );
  ...
  gui
    .add(hemiLight1.position, "x")
    .min(-10)
    .max(10)
    .step(0.001)
    .name("Hemi 1 lightX");
  gui
    .add(hemiLight1.position, "y")
    .min(-10)
    .max(10)
    .step(0.001)
    .name(" Hemi 1 lightY");
  gui
    .add(hemiLight1.position, "z")
    .min(-10)
    .max(10)
    .step(0.001)
    .name(" Hemi 1 lightZ");
  ...
  const hemiLight2Lighthelper = new THREE.HemisphereLightHelper(
    hemiLight2,
    2,
    0x0000ff
  );
  ...
  gui
    .add(hemiLight2.position, "x")
    .min(-10)
    .max(10)
    .step(0.001)
    .name("Hemi 2 lightX");
  gui
    .add(hemiLight2.position, "y")
    .min(-10)
    .max(10)
    .step(0.001)
    .name("Hemi 2lightY");
  gui
    .add(hemiLight2.position, "z")
    .min(-10)
    .max(10)
    .step(0.001)
    .name("Hemi 2 lightZ");
